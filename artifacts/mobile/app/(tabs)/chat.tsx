...
import {
  ...
  TextInput, Platform, Alert, Image, Linking, ActivityIndicator,
} from 'react-native';
...
export default function ChatScreen() {
  ...
  const { messages, sendMessage, sendLocation, sendImage, isSendingImage } = useChat();
  const { rideGroup, connectedRiders, currentUser } = useApp();
